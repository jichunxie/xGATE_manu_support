...
# Produced by ../../run_xgate_spatial.py (xGATE pathway activity per subdomain;
# columns pathway,domain,cluster,p-value). Regenerate from the subdomain SCT matrices.
