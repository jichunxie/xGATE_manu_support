...
# Input files
# PATHWAY_FILE is produced by ../../run_xgate_spatial.py (xGATE pathway activity per
# subdomain; columns pathway,domain,cluster,p-value). Regenerate it from the
# subdomain SCT matrices, or request it, before running the pathway-plot scripts.
PATHWAY_FILE <- file.path(RAW_DATA_DIR, "colon_pathway_analysis_results_xgate_subdomain.csv")
