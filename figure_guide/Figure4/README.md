...
|-------|-----------------|-----------------|------------------|--------|
| Fig 4 (a-f) | `analysis/figure4_5_spatial_crc_prostate/analysis/crc/scripts/00_...12_*.R` | CRC raw (`countList_spatial_crc.RDS`, `sc_input_crc.RDS`) | spatial panels for `Figure4.jpeg` | verified; external data required |
| `Supp_CRC_pathways` | same CRC R pipeline | same CRC raw inputs | `Supp_CRC_pathways.jpeg` panels | likely; external data required |
