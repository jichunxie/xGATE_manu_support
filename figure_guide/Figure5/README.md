...
|-------|-----------------|-----------------|------------------|
| Fig 5 | `analysis/figure4_5_spatial_crc_prostate/analysis/prostate/scripts/00_...10_*.R` | prostate raw (`matrix.mtx`, `barcodes.tsv`, `features.tsv`, `spatial_location.csv`) | spatial panels for `Figure5.jpeg` |
| `Supp_prostate_pathways` | same prostate R pipeline | same prostate raw inputs | `Supp_prostate_pathways.jpeg` panels |
