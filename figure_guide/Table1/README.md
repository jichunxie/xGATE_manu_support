...
| Item | Backend script | Required input | Expected outputs | Command | Status |
|------|----------------|----------------|------------------|---------|--------|
| Table 1 | `analysis/table1_complexity/table1_runtime.py` | `computational_benchmark_summary.csv` plus `computational_benchmark_summary_additions.csv` (**not shipped**) | `results/table1_runtime_table.csv`, `figures/table1_complexity_analysis.{png,pdf}` | `make complexity` | verified |
